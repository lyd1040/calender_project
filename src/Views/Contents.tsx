...
function Contents(props:ContnetsProps){
    /* 날짜 클릭시 Header에 날짜 출력 및 캘린더 숨기고 나타내는 함수 */
        ...
        if(tr_idx===0){
            for(let x=(tr_idx*7); x<(tr_idx*7)+7; x++){
                if(x>=frist_week_first_day){
                    date_td.push(
                        <td key={'date_text'+date_text+x} onClick={()=>{hide_calendar(year, month, (x+1)-frist_week_first_day);}}>
    ...
    return(
        <article>
            <div id="calendar" className='calendar'>
                ...
                <a href="/" className='show_calendar' onClick={e=>{e.preventDefault(); show_calendar()}}><i className="fa-solid fa-chevron-right"></i></a>
            </div>
